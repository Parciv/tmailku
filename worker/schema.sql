...
INSERT OR IGNORE INTO settings (key, value, "group", type, label, updated_at) VALUES
  ...
  ('color_primary', '#6366f1', 'branding', 'color', 'Primary Color', 0),
  ('color_secondary', '#22c55e', 'branding', 'color', 'Secondary Color', 0),
  ('color_tertiary', '#f59e0b', 'branding', 'color', 'Tertiary Color', 0),
